...
class PreprocessingPanel(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        grid.addWidget(self.grayscale, 1, 0)
        grid.addWidget(QLabel("Contrast"), 1, 1)
        grid.addWidget(self.contrast, 1, 2)
        grid.addWidget(QLabel("Brightness"), 1, 3)
        grid.addWidget(self.brightness, 1, 4)
        grid.addWidget(self.denoise, 2, 0)
        grid.addWidget(self.sharpen, 2, 1)
        grid.addWidget(self.threshold, 2, 2)
        grid.addWidget(self.invert, 2, 3)
        grid.addWidget(self.deskew, 2, 4)
        grid.addWidget(QLabel("Upscale"), 3, 0)
        grid.addWidget(self.upscale, 3, 1)
        root.addLayout(grid)
